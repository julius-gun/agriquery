...
```
cd existing_repo
git remote add origin https://gitlab.lrz.de/p_llm_manual/p_llm_manual.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.lrz.de/p_llm_manual/p_llm_manual/-/settings/integrations)
